...
class Luscious(override val lang: String, private val lusLang: String, private val member: Boolean) : HttpSource() {
    if (member == true){
        override val baseUrl: String = "https://members.luscious.net"
        private val apiBaseUrl: String = "https://members.luscious.net/graphql/nobatch/"
    } else {
