...
class MangaMainacGenerator : ThemeSourceGenerator {
    ...
    override val sources = listOf(
        ...
        SingleLang("TCB Scans", "https://onepiecechapters.com/", "en", className = "TCBScans", pkgName = "tcbscans"), // Need to check what original extension was called going by title card at the moment
